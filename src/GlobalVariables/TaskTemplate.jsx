...
const TaskTemplate = () => {
  ...
  const TaskDetails = [
    ...
    },
    {
      id: "4",
      name: "Meditation",
      icon: <FaPeace className="text-purple-500" />,
    },
    {
      id: "5",
    ...
    { id: "6", name: "Eat Fruits", icon: <FaApple className="text-red-500" /> },
    {
      id: "7",
      name: "Stretch",
      icon: <FaExpandArrowsAlt className="text-amber-900" />,
    },
    {
      id: "8",
      name: "Go Shopping",
    ...
    {
      id: "9",
      name: "Practice Smiling and Happy",
      icon: <FaSmile className="text-orange-500" />,
    },
    {
      id: "10",
      name: "Learn a Foreign Language",
      icon: <FaLanguage className="text-blue-900" />,
    },
    {
      id: "11",
      name: "Take a Break",
      icon: <FaTimes className="text-emerald-700" />,
    },
    {
      id: "12",
      name: "Take Pill Reminder",
      icon: <FaPills className="text-fuchsia-950" />,
    },
    {
      id: "13",
      name: "Keep in Touch with Family",
      icon: <FaEnvelopeOpen className="text-lime-300" />,
    },
  ...
  return (
    <div className="p-4 space-y-3">
      <div className="text-[#000080] text-lg font-semibold mb-2">
        Task Template
      </div>
        ...
        >
          ...
          <div className="relative">
            <DatePicker
              ...
              onChange={(date) =>
                setTaskDate((prev) => ({ ...prev, [task.id]: date }))
              }
          ...
          <Select
            ...
            onChange={(selected) =>
              setTaskCategory((prev) => ({ ...prev, [task.id]: selected }))
            }
          ...
          <Select
            ...
            onChange={(selected) =>
              setPriority((prev) => ({ ...prev, [task.id]: selected }))
            }
