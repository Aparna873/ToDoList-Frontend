      ...
      <div className="w-full max-w-md p-6 bg-white rounded-2xl shadow-lg">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-2 mt-4 bg-[#2A3674] text-white font-semibold rounded-lg hover:bg-red-700 transition duration-200 disabled:bg-blue-300 disabled:cursor-not-allowed"
          >
